...
public final class FileUtils {
    ...
    public static boolean delete(File file, boolean deleteRootDir) {
        ...
        if (file.isFile()) {
            ...
            if (files.length == 0) {
                boolean isDelete = deleteResolveEBUSY(file);
                result = deleteRootDir && isDelete;
            } else {
                for (File f : files) {
    ...
    public static boolean rename(File src, File tar) {
        if (src.renameTo(tar)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                return document.renameTo(tar.getAbsolutePath());
            }
        }
        return false;
    }
    ...
    public static String getSize(String path) {
        ...
        return ConvertUtils.byte2FitMemorySize(fileSize);
    }
    ...
    public static String getDateTime(File file, String format) {
        ...
        return ConvertUtils.formatDate(cal.getTime(), format);
    }
        ...
        public int compare(File f1, File f2) {
            if (f1 == null || f2 == null) {
                ...
                if (f1.isDirectory() && f2.isFile()) {
                    ...
                    return FileUtils.getExtension(f1.getName()).compareToIgnoreCase(FileUtils.getExtension(f2.getName()));
                }
            }
        }
    ...
    public static class SortByEssExtension implements Comparator<EssFile> {

        public SortByEssExtension() {
            super();
        }
    ...
    public static class SortByEssName implements Comparator<EssFile> {
        private boolean caseSensitive;

        public SortByEssName(boolean caseSensitive) {
            this.caseSensitive = caseSensitive;
        }

        public SortByEssName() {
            this.caseSensitive = false;
        }
        ...
        public int compare(EssFile f1, EssFile f2) {
            if (f1 == null || f2 == null) {
                ...
                if (f1.isDirectory && f2.isFile) {
                    ...
                    String s1 = f1.mFileName;
                    String s2 = f2.mFileName;
                    if (caseSensitive) {
                        return s1.compareTo(s2);
                    } else {
                        return s1.compareToIgnoreCase(s2);
    ...
    public static class SortByEssSize implements Comparator<EssFile> {

        public SortByEssSize() {
            super();
        }
    ...
    public static class SortByEssTime implements Comparator<EssFile> {

        public SortByEssTime() {
            super();
        }
